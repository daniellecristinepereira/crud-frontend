                    ...
                    <div
                        ...
                        <div class="rounded-t mb-0 px-0 border-0">
                            <div class="flex flex-wrap items-center px-4 py-2">
                                ...
                                <h3 class="font-semibold text-base text-gray-900 dark:text-gray-50">EDITAR PRODUTO </h3>
                                </div>
...
export default {
    ...
    methods: {
        ...
        async sendForm($event) {
            ...
            await this.$axios.$put(`/customers/${this.$route.params.id}`, filds).then(success => {
