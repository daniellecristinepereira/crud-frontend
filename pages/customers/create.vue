                    ...
                    <div class="rounded-t mb-0 px-0 border-0">
                        <div class="flex flex-wrap items-center px-4 py-2">
                            <div class="relative w-full max-w-full flex-grow flex-1">
                                <h3 class="font-semibold text-base text-gray-900">CADASTRAR NOVO PRODUTO</h3>
                            </div>
                            <div class="relative w-full max-w-full flex-grow flex-1 text-right">
                                <nuxt-link to="/customers" class="bg-teal-400 text-white active:bg-blue-600 text-xs font-bold uppercase px-3 py-1 rounded outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150">
                                    VOLTAR
                                </nuxt-link>
                            </div>
                        </div>
                    ...
                    <div class="max-w-2xl mx-auto bg-white p-16">
                        <form  @submit="sendForm($event)" >
                            <div class="grid gap-6 mb-6 lg:grid-cols-1">
                                ...
                                <div>
                                    <label for="phone"
                                        class="block mb-2 text-sm font-medium text-gray-900">Telefone
                                        </label>
...
methods: {
    async sendForm($event) {
        ...
        await this.$axios.$post("/customers", filds).then(success => {
